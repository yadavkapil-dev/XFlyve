...
module.exports = {
  ...
  "/api/jobs/admin/ready-for-invoicing": {
    get: {
      ...
      description: "A job (local or interstate) is ready once it's completed and has an approved POD — work diaries and work logs are both still required as submitted records (neither has an approval step), but neither gates invoicing. Never returns archived, in-progress/pending, or already-invoiced/paid jobs.",
      security: h.bearer,
      responses: {
